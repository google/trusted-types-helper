...
import { haveSameRootCause } from "../common/cluster";
...
describe("haveSameRootCause function", () => {
  ...
  it("clusters violations with the same stack trace but different payloads", () => {
    const innerHtmlViolation1: Violation = createViolation(
    ...
    const innerHtmlViolation2: Violation = createViolation(
  ...
  it("clusters violations with the same first stack frame (DOM sink + source file)", () => {
    const scriptSrcViolation1: Violation = createViolation(
      "www.myurl.com",
      "Script",
      fakeTimestamp,
      {
    ...
    const scriptSrcViolation2: Violation = createViolation(
  ...
  it("doesn't cluster violations with different initial stack frames", () => {
    const setAttributeViolation: Violation = createViolation(
      "www.myurl.com",
      "HTML",
      fakeTimestamp,
      {
  ...
  it("doesn't cluster violations with different ViolationTypes", () => {
    const innerHtmlViolationWithUrlPayload: Violation = createViolation(
      "www.myurl.com",
      "HTML",
      fakeTimestamp,
      innerHTMLStackTrace,
    ...
    const scriptSrcViolation: Violation = createViolation(
      "www.myurl.com",
      "Script",
      fakeTimestamp,
      scriptSrcStackTrace,
  ...
  it("doesn't cluster violations with same function name but differnt columnn/line numbers", () => {
    ...
    const setAttributeViolation1: Violation = createViolation(
      "www.myurl.com",
      "Script",
      fakeTimestamp,
      {
    ...
    const setAttributeViolation2: Violation = createViolation(
      "www.myurl.com",
      "Script",
      fakeTimestamp,
      {
